...
*/
    ...
    $('#changePasswdTransaction').on('submit', function() {
        ...
        if (!$('#TranoldPassword').existsWithValue()) {
            ...
            $('#TranoldPassword').attr('placeholder','Please enter old password');
        ...
        if (!$('#Tranpassword_New').existsWithValue()) {
            ...
            $('#Tranpassword_New').attr('placeholder','Please enter new password');
        ...
        if($('#Tranpassword_New').val() !== $('#TranConfirmPassword').val()){
            ...
            $('#TranConfirmPassword').attr('placeholder','Confirm new password not correct');
    ...
    $('#frmChangePassword').on('submit', function() {
        ...
        if (!$('#OldPassword').existsWithValue()) {
            ...
            $('#OldPassword').focus();
            $('#OldPassword').attr('placeholder','Please enter old password');
        ...
        if($('#Password').val() !== $('#ConfirmPassword').val()){
            ...
            $('#ConfirmPassword').attr('placeholder','Confirm new password not correct');
        ...
        if(!_checkOldPasswd){
            ...
            $('#OldPassword').focus();
            $('#OldPassword').val('');
            $('#OldPassword').attr('placeholder','Wrong old password, please try again');
