...
<div class="item-page_home" itemscope="" itemtype="https://schema.org/Article">
   ...
   <div itemprop="articleBody">
      <div class="cf content contentpaneopen_home">
         <div class="col-md-6 homepage_left">
            <h2>A leader in income-oriented investing</h2>
            <p>MacKay Shields is a fixed income focused investment management firm that specializes in the management of income-oriented investment strategies. We manage over $94 billion in assets – with industry acknowledged expertise in credit intensive research and asset allocation strategies.</p>
            <p>Our approach is ideally suited for income-oriented investors seeking attractive risk-adjusted returns. Our investment teams recognize and integrate the importance of capital preservation into all of their investment philosophies.</p>
            <p><strong>At MacKay Shields we are committed to partnering with our clients to deliver tailored income-oriented investment solutions based on their goals and objectives.</strong></p>
            <div class="content-article cf" style="border-bottom: 1px solid #B9B9B9">
            ...
            <br>
            <p class="fine-print no-border">Information above is as of December 31, 2016. Investment goals may not be achieved and past performance is no guarantee of future results.</p>

            <div class="col-md-12 text-center">

            <div class="homepage_left">    <div class="moduletable">
            

              <div class="contact-info">


              <img src="catalog/view/theme/default/home/images/contact-info-header.png" alt=""><br><span>For more information please contact:<br></span>John W. Akkerman, CFA, CAIA<br>Global Head of Distribution<br>212.230.3805 or <span id="cloak04062b526dee201d74400edccfb35b79"><a href="mailto:answers@mackayshields.com">Email</a></span>
              </div>   </div>
             </div>
         ...
         <div>
            <div class="content-body col-md-6 homepage_right">
               <div class="componentheading" style="font-size: 16px; border-bottom:none; margin-bottom:8px; margin-top: 2px;text-transform: None;">
                  <div style="height:20px; border-bottom: 1px solid #B9B9B9;">
                     <span style="float:left;"><em>Featured Perspectives</em></span>
                     <a href="/insights-landing" style="float:right; color:#0a3555; font-size:12px; padding-top:4px;">View More</a>
                  </div>
               </div>
               <div class="row">
